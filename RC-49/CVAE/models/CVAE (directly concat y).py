...
class CVAE_encoder(nn.Module):
    def __init__(self, zdim:int, ydim:int):
        ...
        self.linear1 = nn.Linear(in_features=1024+ydim, out_features=zdim)
        self.linear2 = nn.Linear(in_features=1024+ydim, out_features=zdim)
...
class CVAE_decoder(nn.Module):
    def __init__(self, zdim:int, ydim:int):
        ...
        self.linearMix = nn.Linear(in_features=zdim+1, out_features=256)
