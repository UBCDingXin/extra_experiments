...
if not os.path.isfile(Filename_GAN):
        ...
        # Start training
        netG, netD, netDH, netQH, netCR = train_infogan(images, args.cr_gap, netG, netD, netDH, netQH, netCR, save_images_folder=save_images_folder, save_models_folder = save_models_folder)
