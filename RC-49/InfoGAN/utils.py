...
class IMGs_dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.normalize:
            image = image/255.0
            # image = (image-0.5)/0.5 #In InfoGAN, images are normalized to [0,1]
...
################################################################################
# Loss function for continuous latetn code
# Based on https://github.com/Natsu6767/InfoGAN-PyTorch/blob/4586919f2821b9b2e4aeff8a07c5003a5905c7f9/utils.py#L15
class NormalNLLLoss:
    """
...
################################################################################
# weights initialization for G and D
# based on https://github.com/eriklindernoren/PyTorch-GAN/blob/36d3c77e5ff20ebe0aeefd322326a134a279b93e/implementations/infogan/infogan.py#L41
