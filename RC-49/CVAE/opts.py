...
def parse_opts():
    ...
    ''' Overall Settings '''
    parser.add_argument('--root_path', type=str, default='G:/OneDrive/Working_directory/CcGAN_TPAMI/RC-49/RC-49_64x64/CVAE')
    ...
    ''' GAN settings '''
    parser.add_argument('--niters', type=int, default=1000, help='number of iterations')
    ...
    parser.add_argument('--dim_z', type=int, default=256, help='dim of noise')
    parser.add_argument('--dim_c', type=int, default=1, help='dim of latent continuous codes')
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--visualize_freq', type=int, default=1000, help='frequency of visualization')
